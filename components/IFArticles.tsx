...
const GET_IF_STORIES = gql`
  query GetIFPosts {
    category(id: "In Focus", idType: NAME) {
      posts {
        nodes {
          id
          title
...
const IFStories: React.FC = () => {
    const { data, loading, error } = useQuery(GET_IF_STORIES);

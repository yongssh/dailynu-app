...
const GET_AE_STORIES = gql`
  query GetAEPosts {
    category(id: "Arts and Entertainment", idType: NAME) {
      posts {
        nodes {
          id
          title
...
const AEStories: React.FC = () => {
    const { data, loading, error } = useQuery(GET_AE_STORIES);
